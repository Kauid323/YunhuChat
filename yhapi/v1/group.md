...
```protobuf
name = 2;                    // 群组名称 = 'wqwqwqdd'
introduction = 3;            // 群组简介 = 'fewewfewff'
avatar_url = 4;              // 群组头像url = 'https://chat-img.jwznb.com/1f3f851742cd1b79e81ac7bb328ef6df'
category = 5;                // 群组分类 = '技术-玩机'
category_id = 6;              // 分类id = 23
```
